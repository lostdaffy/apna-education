        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 text-[#242424]">
              Find <span className="text-gray-600">Our Office</span>
            </h2>
                  ...
                  <div className="p-6">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="flex items-start">
                        <i className="ri-map-pin-line text-[#242424] mr-4 mt-1 text-xl flex-shrink-0"></i>
                        <div>
                          <div className="font-semibold text-[#242424] mb-1">
                            Address:
                          </div>
                      ...
                      {/* Office Hours */}
                      <div className="flex items-start">
                        <i className="ri-time-line text-[#242424] mr-4 mt-1 text-xl flex-shrink-0"></i>
                        <div>
                          <div className="font-semibold text-[#242424] mb-1">
                            Office Hours:
                          </div>
                      ...
                      <div className="flex items-start">
                        <i className="ri-phone-line text-[#242424] mr-4 mt-1 text-xl flex-shrink-0"></i>
                        <div>
                          <div className="font-semibold text-[#242424] mb-1">
                            Contact:
                          </div>
                      ...
                      <div className="pt-4">
                        <a
                          ...
                          className="w-full bg-[#242424] text-white py-3 px-4 rounded-lg font-semibold hover:bg-gray-700 transition-colors duration-300 flex items-center justify-center"
                        >

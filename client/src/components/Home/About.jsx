        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              <span className="text-lg font-semibold text-[#4ccedc]">
                Who We Are
              </span>

              <h2 className="uppercase text-4xl lg:text-5xl font-bold my-4 text-[#242424]">
                About <span className="text-[#4ccedc]">Apna Education</span>
              </h2>
              <div className="py-5">
              ...
              <Link to="/about" className="bg-gray-900 text-[#4ccedc] font-semibold text-base rounded-full py-4 px-10 hover:bg-gray-700">
